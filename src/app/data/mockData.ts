export interface Project {
  ...
  status: 'draft' | 'review' | 'published' | 'execution';
  stage: string;
  description: string;
  image: string;
  highlights: string[];
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    sector: 'Energy',
    location: 'Can Gio, Ho Chi Minh City',
    province: 'Ho Chi Minh City',
    budget: 200,
    minInvestment: 20,
    status: 'published',
  ...
  },
  {
    ...
    sector: 'Technology',
    location: 'Saigon Hi-Tech Park, Thu Duc City, Ho Chi Minh City',
    province: 'Ho Chi Minh City',
    budget: 100,
    minInvestment: 10,
    status: 'review',
...
export const users: User[] = [
  ...
  { id: 'u3', name: 'Le Van Cuong', email: 'lvcuong@hcmc.gov.vn', role: 'Agency User', organization: 'Department of Planning and Investment, Ho Chi Minh City', status: 'active', lastLogin: '2024-03-14 16:45', permissions: ['permit.process', 'service.process'] },
  { id: 'u4', name: 'Pham Thi Dung', email: 'ptdung@donre.hochiminhcity.gov.vn', role: 'Agency User', organization: 'Department of Natural Resources and Environment, Ho Chi Minh City', status: 'active', lastLogin: '2024-03-13 11:00', permissions: ['permit.process', 'service.process', 'issue.update'] },
...
export const agencies: Agency[] = [
  { id: 'ag1', name: 'Department of Planning and Investment', shortName: 'DPI', type: 'Government', jurisdiction: 'National', contactPerson: 'Director Nguyen Van An', email: 'contact@dpi.gov.vn', phone: '+84 24 3843 4712', activeRequests: 12, status: 'active' },
  { id: 'ag2', name: 'Department of Natural Resources and Environment, Ho Chi Minh City', shortName: 'DONRE', type: 'Government', jurisdiction: 'Provincial', contactPerson: 'Director Le Thi Hoa', email: 'donre@hochiminhcity.gov.vn', phone: '+84 28 3829 7800', activeRequests: 8, status: 'active' },
  { id: 'ag3', name: 'Department of Construction, Ho Chi Minh City', shortName: 'DOC', type: 'Government', jurisdiction: 'Provincial', contactPerson: 'Director Tran Van Duc', email: 'doc@hochiminhcity.gov.vn', phone: '+84 28 3822 2214', activeRequests: 5, status: 'active' },
  { id: 'ag4', name: 'General Department of Customs', shortName: 'GDC', type: 'Government', jurisdiction: 'National', contactPerson: 'Director Pham Thi Lan', email: 'customs@gdc.gov.vn', phone: '+84 24 3934 8082', activeRequests: 3, status: 'active' },
  { id: 'ag5', name: 'Department of Labor, Invalids and Social Affairs, Ho Chi Minh City', shortName: 'DOLISA', type: 'Government', jurisdiction: 'Provincial', contactPerson: 'Director Hoang Van Nam', email: 'dolisa@hcmc.gov.vn', phone: '+84 28 3829 7800', activeRequests: 4, status: 'active' },
  { id: 'ag6', name: 'Fire Prevention and Fighting Police, Ho Chi Minh City', shortName: 'PCCC', type: 'Government', jurisdiction: 'Provincial', contactPerson: 'Colonel Nguyen Minh Tuan', email: 'pccc@hcmc.gov.vn', phone: '+84 28 3839 9393', activeRequests: 2, status: 'active' },
];
...
export const funnelData = [
  ...
  { stage: 'In Execution', count: 5, color: '#10B981' },
];
